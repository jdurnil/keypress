...
public class SliderRangeTransitionDemo : MonoBehaviour
{  
    //The SliderRangeTransition Component.
    public SliderRangeTransition m_Slider;
    void Start()
    {
        ...
        //Set axis direction.
        m_Slider.Axis = SliderRangeTransition.AxisEnum.Horizontal;    
    }    
...
namespace RainbowArt.CleanFlatUI
{
    ...
    public class SliderRangeTransition : UIBehaviour, IDragHandler, IInitializePotentialDragHandler, ICanvasElement,IPointerDownHandler
    {
        [SerializeField]
        ...
        [SerializeField]
        Animator animatorHandle1; 

        [SerializeField]
        Animator animatorHandle2; 
        ...
        [SerializeField]
        RangedSliderTransitionEvent onValue1Changed = new RangedSliderTransitionEvent();
        
        [SerializeField]
        RangedSliderTransitionEvent onValue2Changed = new RangedSliderTransitionEvent();
        ...
        public void PlayAnimation(Animator animatorHandle)
        {
            ...
            {
                animatorHandle.Play("Transition",0,0);  
            }    
        }
    }
}

...
{
    [CustomEditor(typeof(ModalWindowRadioButton))]
    public class ModalWindowRadioButtonEditor : Editor
    {
        ...
        SerializedProperty startSelectedIndex;
        ...
        protected virtual void OnEnable()
        {
            ...
            startSelectedIndex = serializedObject.FindProperty("startSelectedIndex");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(startSelectedIndex);

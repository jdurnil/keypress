...
{
    [CustomEditor(typeof(SliderRange))]
    public class SliderRangeEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SliderRange slider = serializedObject.targetObject as SliderRange;
            ...
            {
                slider.SetDirection((SliderRange.AxisEnum)curAxis.enumValueIndex, true);
            }
            EditorGUI.BeginChangeCheck();
